...
create table Athlete ( id integer generated by default as identity, born_at date not null, name varchar(255), rank Integer not null default NEXTVAL('rank_id_seq'), stamp timestamp not null default now(), primary key (id));